...
public class Application implements Runnable {
    //als je dit kan zien, werkt mijn programma niet.
    // Size of each cell
    ...
    public void run() {
        ...
        Color Green = SaxionApp.createColor(0,195,0);
        Color darkBleu = SaxionApp.createColor(0,0,162);
        ...
        SaxionApp.drawRectangle(9*size, 6*size, size, size);
